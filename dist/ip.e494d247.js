...
var generateCardClass = function generateCardClass(objct) {
  ...
  img.src = objct === null || objct === void 0 ? void 0 : objct.ülkebayrağı;
  ip.textContent = "".concat(objct === null || objct === void 0 ? void 0 : objct.sorgu, ";");
  ulkeP.textContent = "".concat(objct.ülke, " (").concat(objct === null || objct === void 0 ? void 0 : objct.ülkeKodu, ")");
  enlemBoylamP.textContent = "Enlem: ".concat(objct === null || objct === void 0 ? void 0 : objct.enlem, " Boylam: ").concat(objct === null || objct === void 0 ? void 0 : objct.boylam);
  sehirP.textContent = "\u015Eehir: ".concat(objct === null || objct === void 0 ? void 0 : objct.şehir);
  saatDilimi.textContent = "Saat Dilimi: ".concat(objct === null || objct === void 0 ? void 0 : objct.saatdilimi);
  paraBirimi.textContent = "Para Birimi: ".concat(objct === null || objct === void 0 ? void 0 : objct.parabirimi);
  ispK.textContent = "ISP: ".concat(objct.isp);
  return cardDiv;
};
var cardContainer = document.querySelector(".cards");
function getApiDetails() {
  var apiRes = null;
  _axios.default.get("https://apis.ergineer.com/ipgeoapi/176.33.67.173").then(function (res) {
    apiRes = res.data;
